...
# YENİ (paket yapına göre birini seç)
from telegram_gate import send_telegram_report_document
# veya
from src.gates.telegram_gate import send_telegram_report_document
